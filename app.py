...
def generate_analysis(tweet):
    ...
    following post, and based on the limited information you have in the content of the post, and what you imagine the other posts from this user and their audience might look like,
    analyze it in terms of the 3 demographic segments of highest likelihood of this post's favorability, explain the meaning of this tweet, why it is likely
    that this post would appeal to each of these principal demographics, suggest slight alterations and additions such that the post might incrementally improve its performance
    among these groups, based on why the post appeals to each demographic:
    
    Post:
    {} """.format(tweet)
    
    system_content = '''You are a social media archivist/modern cultural anthropologist, who wants to help me analyze and interpret this social media post, in context.
...
def generate_word_cloud(demo_analysis):
    ...
    system_content = 'You are accessing the database of a social media archivist/modern cultural anthropologist, who wants to help me analyze and interpret a social media post, in context. '
